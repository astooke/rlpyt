...
script = "rlpyt/ul/experiments/ul_for_rl/scripts/dmcontrol/train_ul/dmc_vae.py"

affinity_code = quick_affinity_code(contexts_per_gpu=2)
runs_per_setting = 1
experiment_title = "dmc_vae_pretrain_1"
...
keys = [("algo", "delta_T"), ("algo", "hidden_sizes")]
variant_levels_1.append(VariantLevel(keys, values, dir_names))
