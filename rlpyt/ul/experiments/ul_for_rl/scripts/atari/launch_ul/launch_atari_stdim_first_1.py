...
script = "rlpyt/ul/experiments/ul_for_rl/scripts/atari/train_ul/atari_stdim.py"

affinity_code = quick_affinity_code(contexts_per_gpu=2)
runs_per_setting = 1
experiment_title = "atari_ul_stdim_1"
variant_levels = list()
...
default_config_key = "atari_stdim"
