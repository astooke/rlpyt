...
runs_per_setting = 3
experiment_title = "atari_ppo_with_ul_stpgrd_1"
...
ul_update_schedules = ["front_10000_1"]
...
ul_max_steps = [None, 20e6]
values = list(zip(ul_max_steps))
dir_names = ["{}maxstepsul".format(*v) for v in values]
keys = [("algo", "max_steps_ul")]
variant_levels_1.append(VariantLevel(keys, values, dir_names))
