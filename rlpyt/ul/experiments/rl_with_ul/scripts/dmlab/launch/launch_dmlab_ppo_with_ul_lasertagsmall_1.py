...
runs_per_setting = 2
experiment_title = "dmlab_ppo_with_ul_lasertagsmall_1"
...
min_steps_ul = [2e4]
ul_pri_alphas = [0]
values = list(zip(min_steps_ul, ul_pri_alphas))
dir_names = ["{}minstepul_{}prialpha".format(*v) for v in values]
keys = [("algo", "min_steps_ul"), ("algo", "ul_pri_alpha")]
variant_levels_1.append(VariantLevel(keys, values, dir_names))

stop_conv_grads = [False, False, True, True]
ul_update_schedules = ["constant_0", "constant_2", "constant_2", "constant_4"]
